...
const Card = ({ item, handleAddToCart, handleDeleteFromCart }: any) => {
  ...
  return (
    <article className={s.itemCard}>
      ...
      {/* add favorite btn */}
      <button aria-label="add to favorites" className={s.addToFavoritesBtn}>
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
      ...
      <div className={s.itemBottomInfoContainer}>
